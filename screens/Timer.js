...
class Timer extends Component {
  ...
  render() {
    ...
    return (
      <View>
         <Text className="title"> (( React Countdown )) </Text>
         <View>
            <Text>Hrs</Text>
         ...
         <View>
            <button onClick={this.startTimer} style={styles.start}>start</button>
            <button onClick={this.stopTimer}  style={styles.stop}>stop</button>
            <button onClick={this.resetTimer}  style={styles.reset}>reset</button>
         </View>
